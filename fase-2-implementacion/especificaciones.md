...
Una vez creada la base de datos, la estructura es sometida a un proceso de validación mediante un programa **`.jar` (verificar)** proporcionado por la cátedra. Este software realiza un análisis exhaustivo sobre la estructura creada para asegurar que cumpla estrictamente con el modelo relacional propuesto y las reglas de integridad definidas
