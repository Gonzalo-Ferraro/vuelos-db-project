...
vuelos.sql: Contiene la secuencia de sentencias para la creación de la base de datos, tablas, vistas y gestión de usuarios.

datos.sql: Incluye una carga inicial de datos de prueba para realizar consultas significativas y validar la integridad del modelo.
